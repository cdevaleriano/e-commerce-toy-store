...
## Dataset
  This project utilizes data from Maven Analytics Fuzzy Factory Set. The data reaches from December 2014 to March 2015 containing data per site entry with corresponding device of origin.
